...
pub fn get_arguments(vm: structs.VirtualMachine, drives: []*structs.Drive) !std.ArrayList([]const u8) {
    ...
    const cpu_str = switch (vm.processor.cpu) {
        ...
        .Nehalem => "Nehalem",
        .Opteron_G1_v1 => "Opteron-G1-v1",
        .Opteron_G1 => "Opteron-G1",
        .Opteron_G2_v1 => "Opteron-G2-v1",
        .Opteron_G2 => "Opteron-G2",
        .Opteron_G3_v1 => "Opteron-G3-v1",
        .Opteron_G3 => "Opteron-G3",
        .Opteron_G4_v1 => "Opteron-G4-v1",
        .Opteron_G4 => "Opteron-G4",
        .Opteron_G5_v1 => "Opteron-G5-v1",
